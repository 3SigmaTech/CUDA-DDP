 ...
 * \note_accuracy_double
 */
extern __device__ __device_builtin__ double norm(int dim, double const * t) __THROW;
 ...
 * \note_accuracy_single
 */
extern __device__ __device_builtin__ float normf(int dim, float const * a) __THROW;
...
#if defined(_LIBCPP_VERSION)
#if defined (__ANDROID__) && (__clang_major__ >= 9)
