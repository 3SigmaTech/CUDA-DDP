...
inline __device__ void *__nv_associate_access_property(const void *ptr, 
                                                       unsigned policy) __DEF_IF_HOST
inline __device__  void __nv_memcpy_async_shared_global_4(void *dst, const void *src, 
                                                          unsigned src_size) __DEF_IF_HOST
inline __device__  void __nv_memcpy_async_shared_global_8(void *dst, const void *src, 
                                                          unsigned src_size) __DEF_IF_HOST
inline __device__  void __nv_memcpy_async_shared_global_16(void *dst, const void *src, 
                                                           unsigned src_size) __DEF_IF_HOST
}
