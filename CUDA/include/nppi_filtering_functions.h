...
nppiDistanceTransformPBA_8u16u_C1R_Ctx(Npp8u * pSrc, int nSrcStep, Npp8u nMinSiteValue, Npp8u nMaxSiteValue,
                                       ...
                                       Npp16s * pDstVoronoiManhattanDistances, int nDstVoronoiManhattanDistancesStep, 
 ...
 */
NppStatus
nppiCompressedMarkerLabelsUFGetGeometryListsSize_C1R(unsigned int nMaxContourPixelGeometryInfoCount, unsigned int * hpBufferSize);
...
NppStatus
nppiCompressedMarkerLabelsUFContoursOutputGeometryLists_C1R(NppiContourPixelGeometryInfo * pContoursPixelGeometryListsHost,
                                                            NppiCompressedMarkerLabelsInfo * pMarkerLabelsInfoListHost,
